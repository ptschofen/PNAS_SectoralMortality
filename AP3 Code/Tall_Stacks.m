...
% Damages = D_PWE;
% run Own_County_Share_Tall
% run Own_State_Share_Tall
% D_PM_T{1,1}(:,1) = ((PM_25 - PM_25_B));
...
% run Own_County_Share_Tall
% run Own_State_Share_Tall
% D_PM_T{4,1}(n,1) =  mean(mean(PM_25 - PM_25_B));
...
% run Own_County_Share_Tall
% run Own_State_Share_Tall
% D_PM_T{5,1}(n,1) =  mean(mean(PM_25 - PM_25_B));
...
% run Population_Weighted_Exposure
% Damages = D_PWE;
% run Own_County_Share_New_Tall
% run Own_State_Share_New_Tall
% D_PM_T2{1,1}(n,1) = sum(sum(PM_25 - PM_25_B));
...
% run Own_County_Share_New_Tall
% run Own_State_Share_New_Tall
% D_PM_T2{2,1}(n,1) = sum(sum(PM_25 - PM_25_B));
...
% run Own_County_Share_New_Tall
% run Own_State_Share_New_Tall
% D_PM_T2{3,1}(n,1) = sum(sum(PM_25 - PM_25_B));
...
% run Own_County_Share_New_Tall
% run Own_State_Share_New_Tall
% D_PM_T2{4,1}(n,1) = sum(sum(PM_25 - PM_25_B));
...
%     Emission_Plus = (0.50.*New_Tall {4,1}(:,6)'+I (n,:));
    A_VOC (:,5) = ((0.03.*Emission_Plus)*(VOC_New_Tall))';    
...
% run Own_County_Share_New_Tall
% run Own_State_Share_New_Tall
% D_PM_T2{5,1}(n,1) = sum(sum(PM_25 - PM_25_B));
